<h1 align="center">Bem vindo ao meu 🌍</h1>
...
| :--- | :--- | :--- |
| 🏥 **[Projeto TISS](https://github.com/LucasTagliaferro/projeto_TISS)** | Solução focada na exportação de arquivos XML dentro do padrão da saúde suplementar (TISS). | `Python` `Django` `BootStrap`   |
| ⚙️ **[Automex C#](https://github.com/LucasTagliaferro/Automex_Csharp)** | Sistema de automação de arquivos no padrão TISS, com base em regras de negocio. | `C#` `.NET` `Angular` |
